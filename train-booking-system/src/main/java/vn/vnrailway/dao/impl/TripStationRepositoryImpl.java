...
public class TripStationRepositoryImpl implements TripStationRepository {
    ...
    public TripStation save(TripStation tripStation) throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection();
            ...
            ps.setTimestamp(4, tripStation.getScheduledArrival() != null ? Timestamp.valueOf(tripStation.getScheduledArrival()) : null);
            ps.setTimestamp(5, tripStation.getScheduledDeparture() != null ? Timestamp.valueOf(tripStation.getScheduledDeparture()) : null);
            ps.setTimestamp(6, tripStation.getActualArrival() != null ? Timestamp.valueOf(tripStation.getActualArrival()) : null);
            ps.setTimestamp(7, tripStation.getActualDeparture() != null ? Timestamp.valueOf(tripStation.getActualDeparture()) : null);
