...
public interface PricingRuleRepository {
    ...
    // More specific finders can be added based on criteria like TrainType, CoachType, etc.
    // e.g., List<PricingRule> findByTrainTypeId(int trainTypeId, LocalDate forDate) throws SQLException;
