...
public class ResetPasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (otpVerified == null || !otpVerified || email == null) {
            ...
            response.sendRedirect(request.getContextPath() + "/forgotpassword"); // Redirect to servlet
            return;
        }
        ...
        try {
            ...
            if (userOptional.isPresent()) {
                ...
                if (HashPassword.checkPassword(newPassword, currentUser.getPasswordHash())) {
                    ...
                    request.setAttribute("messageType", "error");
                    request.getRequestDispatcher("/WEB-INF/jsp/authentication/newpassword.jsp").forward(request,
                            response);
                    return;
                }
            } else {
