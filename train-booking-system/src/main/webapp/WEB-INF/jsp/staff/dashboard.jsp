        ...
        <div class="dashboard-container">
            <aside class="sidebar">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/checkRefundTicket">Kiểm tra vào/ra</a></li>
            ...
            <main class="main-content">
                ...
                <section class="charts-container">
                    ...
                    <div
                        style="height: 300px; background-color: #f0f0f0; border-radius: 8px; display: flex; align-items: center; justify-content: center; color: #666;">
