                            ...
                            <div class="form-container">
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/createPolicy"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="hoursMin" name="hoursMin" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="hoursMax">Giờ tối đa:</label>
                                        <input type="number" id="hoursMax" name="hoursMax">
                                    </div>

                                    <div class="form-group">
                                        <label for="feePercentage">Phí %:</label>
                                        <input type="number" step="0.01" id="feePercentage" name="feePercentage">
                                    </div>

                                    <div class="form-group">
                                        <label for="fixedFeeAmount">Phí cố định:</label>
                                        <input type="number" step="0.01" id="fixedFeeAmount" name="fixedFeeAmount">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="effectiveFromDate" name="effectiveFromDate" required>
                                    </div>
