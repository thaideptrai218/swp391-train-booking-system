                                                ...
                                                <td style="text-align: center;">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${info.ticketStatus == 'Refunded'}">
                                                            <span style="color: #dc3545; font-weight: bold;">Đã hoàn
                                                                tiền</span> <!-- đỏ đậm -->
                                                        </c:when>
                                                        <c:when test="${info.ticketStatus == 'RejectedRefund'}">
                                                            <span style="color: #dc3545; font-weight: bold;">Đã từ chối
                                                                hoàn tiền</span> <!-- đỏ đậm -->
                                                        </c:when>
                                                        <c:when test="${info.ticketStatus == 'Cancelled'}">
                                                            <span style="color: #dc3545; font-weight: bold;">Chuyến đi
                                                                bị hủy</span> <!-- đỏ đậm -->
                                                        </c:when>
