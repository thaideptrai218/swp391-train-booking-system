            ...
            >
                ...
                <section class="trip-section outbound-section">
                    <div class="trip-header">
                        <h2 class="title">
                            Chiều đi:
                            <c:out value="${departureDateDisplay}" /> từ
                        ...
                        <c:when test="${not empty outboundTrips}">
                            <div class="train-list">
                                <c:forEach var="trip" items="${outboundTrips}">
                                    ...
                                    >
                                        <div
                                            class="train-item-collapsed-summary"
                                        >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            />
                                                            <span
                                                                class="carriage-number-label"
                                                                >Toa
                                                                ${coachInfo.positionInTrain}</span
                                                            >
                                                        </div>
                                                    </c:forEach>
                                                </c:if>
                ...
                <c:if test="${not empty returnDateDisplay}">
                    <section class="trip-section return-section">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <p class="no-results">
                                    Không tìm thấy chuyến về nào phù hợp.
                                </p>
                            </c:otherwise>
                        </c:choose>
                    </section>
