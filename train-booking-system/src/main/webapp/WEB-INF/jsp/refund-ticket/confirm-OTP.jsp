...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <form id="otpForm" action="${pageContext.request.contextPath}/confirmOTP" method="post" class="login-form">
            ...
            <div class="register-section">
                <p>Chưa nhận được mã? <a href="${pageContext.request.contextPath}/confirmRefundTicket?action=resend" class="register-link">Gửi lại mã</a></p>
            </div>
        </div>
    </div>
