...
<html lang="en">
    <head>
        ...
        <style>
            body {
                ...
                height: 100vh;
                margin: 0;
                font-family: "Comic Sans MS", "Chalkboard SE", "Arial",
                    sans-serif;
    ...
    <body>
        <div class="container">
            ...
            <%-- Display specific error information if available --%> <% String
            errorMessage = (String) request.getAttribute("errorMessage"); %> <%
            String userRole = (String) request.getAttribute("userRole"); %> <%
            String requestedPath = (String)
            request.getAttribute("requestedPath"); %> <% if (errorMessage !=
            null) { %>
            <p style="color: #f39c12; font-weight: bold"><%= errorMessage %></p>
            <% } %> <% if (userRole != null && requestedPath != null) { %>
            <p style="color: #bdc3c7">
                Vai trò hiện tại:
                <strong style="color: #e67e22"><%= userRole %></strong><br />
                Đường dẫn yêu cầu:
                <strong style="color: #e67e22"><%= requestedPath %></strong>
            </p>
            <% } %>

            <p>
                ĐIỀU NÀY CÓ THỂ DO BẠN ĐANG CỐ GẮNG TRUY CẬP ĐẾN MỘT ĐỊA CHỈ BỊ
                HẠN CHẾ (QUAY LẠI MÀN HÌNH CHÍNH)
            </p>
            <p>
                HOẶC PHIÊN ĐĂNG NHẬP CỦA BẠN ĐÃ HẾT HẠN (QUAY LẠI MÀN ĐĂNG
                NHẬP).
            </p>
            <div class="link-container">
                ...
                <%-- Show role-specific dashboard links if user is logged in
                --%> <% if (userRole != null) { %> <% if
            ...
            <%-- Or a more specific link based on user role if available, e.g.,
