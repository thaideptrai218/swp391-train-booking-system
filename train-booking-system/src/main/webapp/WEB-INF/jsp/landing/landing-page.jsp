<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body data-context-path="${pageContext.request.contextPath}">
                  ...
                  <c:when
                    ...
                    <li class="profile-dropdown-container">
                      ...
                      <div class="profile-dropdown-menu" id="profileDropdown">
                        ...
                        <a href="${pageContext.request.contextPath}/customer-profile" class="dropdown-item">👥 Xem tất
                          cả trang cá nhân</a>
                        <a href="#" class="dropdown-item">⚙️ Cài đặt và quyền riêng tư
                          <span class="arrow-right">➡️</span></a>
                        <a href="#" class="dropdown-item">❓ Trợ giúp và hỗ trợ
                          <span class="arrow-right">➡️</span></a>
                        <a href="#" class="dropdown-item">🌙 Màn hình & trợ năng
                          <span class="arrow-right">➡️</span></a>
                        <a href="#" class="dropdown-item">💬 Đóng góp ý kiến</a>
                        <a href="${pageContext.request.contextPath}/logout" class="dropdown-item logout-item">🚪 Đăng
                          xuất</a>
                      </div>
                    </li>
                  </c:when>
      ...
      <c:if test="${not empty sessionScope.successMessage}">
        <div class="alert alert-success" style="padding: 15px 20px;
  margin: 20px auto;
  max-width: 1000px;
  border-radius: 8px;
  font-size: 16px;
  ...
  color: #155724;
  border-left: 6px solid #28a745;">${sessionScope.successMessage}</div>
