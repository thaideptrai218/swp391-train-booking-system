...
INSERT INTO Users (FullName, Email, PhoneNumber, PasswordHash, IDCardNumber, Role, IsActive, CreatedAt, LastLogin) VALUES
(N'Trần Văn Quản Trị', 'admin.super@vnrailway.com', '0901000001', 'hashed_pw_admin_super', '001080000001', 'Admin', 1, DATEADD(year, -2, GETDATE()), DATEADD(day, -1, GETDATE())),
(N'Nguyễn Thị Điều Phối', 'staff.dispatch01@vnrailway.com', '0902000002', 'hashed_pw_staff_dispatch01', '001085000002', 'Staff', 1, DATEADD(month, -18, GETDATE()), DATEADD(day, -2, GETDATE())),
(N'Lê Minh Hỗ Trợ', 'staff.support01@vnrailway.com', '0903000003', 'hashed_pw_staff_support01', '001090000003', 'Staff', 1, DATEADD(month, -15, GETDATE()), DATEADD(hour, -5, GETDATE())),
(N'Phạm Hùng Kỹ Thuật', 'staff.tech01@vnrailway.com', '0904000004', 'hashed_pw_staff_tech01', '001075000004', 'Staff', 0, DATEADD(month, -20, GETDATE()), DATEADD(day, -30, GETDATE())), -- Inactive staff
(N'Hoàng Bích Phượng', 'staff.accounting01@vnrailway.com', '0905000005', 'hashed_pw_staff_acc01', '001088000005', 'Staff', 1, DATEADD(month, -10, GETDATE()), DATEADD(day, -3, GETDATE()));

-- Batch 2: Regular Customers
INSERT INTO Users (FullName, Email, PhoneNumber, PasswordHash, IDCardNumber, Role, IsActive, CreatedAt, LastLogin) VALUES
(N'Nguyễn Văn An', 'an.nguyen@email.com', '0912345001', 'hashed_pw_customer001', '030080000101', 'Customer', 1, DATEADD(day, -300, GETDATE()), DATEADD(day, -5, GETDATE())),
(N'Trần Thị Bình', 'binh.tran@email.com', '0912345002', 'hashed_pw_customer002', '030081000102', 'Customer', 1, DATEADD(day, -250, GETDATE()), DATEADD(day, -10, GETDATE())),
(N'Lê Văn Cường', 'cuong.le@email.com', '0912345003', 'hashed_pw_customer003', NULL, 'Customer', 1, DATEADD(day, -200, GETDATE()), DATEADD(day, -3, GETDATE())), -- No ID Card
(N'Phạm Thị Dung', 'dung.pham@email.com', '0912345004', 'hashed_pw_customer004', '030083000104', 'Customer', 1, DATEADD(day, -180, GETDATE()), DATEADD(day, -7, GETDATE())),
(N'Hoàng Văn Em', 'em.hoang@email.com', '0912345005', 'hashed_pw_customer005', '030084000105', 'Customer', 0, DATEADD(day, -150, GETDATE()), DATEADD(day, -60, GETDATE())), -- Inactive customer
(N'Vũ Thị Giang', 'giang.vu@email.com', '0988111222', 'hashed_pw_customer006', '031085000106', 'Customer', 1, DATEADD(day, -120, GETDATE()), DATEADD(day, -1, GETDATE())),
(N'Đỗ Văn Hùng', 'hung.do@email.com', '0988111333', 'hashed_pw_customer007', '031086000107', 'Customer', 1, DATEADD(day, -100, GETDATE()), DATEADD(day, -15, GETDATE())),
(N'Trịnh Thị Kim', 'kim.trinh@email.com', '0988111444', 'hashed_pw_customer008', NULL, 'Customer', 1, DATEADD(day, -90, GETDATE()), DATEADD(day, -20, GETDATE())),
(N'Mai Văn Lộc', 'loc.mai@email.com', '0988111555', 'hashed_pw_customer009', '031088000109', 'Customer', 1, DATEADD(day, -80, GETDATE()), DATEADD(hour, -8, GETDATE())),
(N'Bùi Thị Mơ', 'mo.bui@email.com', '0988111666', 'hashed_pw_customer010', '031089000110', 'Customer', 1, DATEADD(day, -70, GETDATE()), DATEADD(day, -2, GETDATE()));

-- Batch 3: More Customers with varied details
INSERT INTO Users (FullName, Email, PhoneNumber, PasswordHash, IDCardNumber, Role, IsActive, CreatedAt, LastLogin) VALUES
(N'Đặng Quốc Nam', 'nam.dang@company.com', '0977001001', 'hashed_pw_customer011', '032090000111', 'Customer', 1, DATEADD(day, -65, GETDATE()), DATEADD(day, -4, GETDATE())),
(N'Ông Thị Oanh', 'oanh.ong@personal.net', '0977001002', 'hashed_pw_customer012', '032091000112', 'Customer', 1, DATEADD(day, -60, GETDATE()), DATEADD(day, -9, GETDATE())),
(N'Phan Văn Phát', 'phat.phan.vn@domain.org', '0977001003', 'hashed_pw_customer013', NULL, 'Customer', 1, DATEADD(day, -55, GETDATE()), DATEADD(day, -6, GETDATE())),
(N'Quách Thị Quyên', 'quyen.quach.lovely@mail.co', '0977001004', 'hashed_pw_customer014', '032093000114', 'Customer', 1, DATEADD(day, -50, GETDATE()), DATEADD(day, -11, GETDATE())),
(N'Đinh Công Sử', 'su.dinh.official@work.com', '0977001005', 'hashed_pw_customer015', '032094000115', 'Customer', 1, DATEADD(day, -45, GETDATE()), DATEADD(day, -1, GETDATE()));

-- Batch 4: Customers who signed up recently, some might not have logged in
INSERT INTO Users (FullName, Email, PhoneNumber, PasswordHash, IDCardNumber, Role, IsActive, CreatedAt, LastLogin) VALUES
(N'Tôn Nữ Thanh Tâm', 'tam.tonnu@newmail.com', '0966002001', 'hashed_pw_customer016', '033095000116', 'Customer', 1, DATEADD(day, -20, GETDATE()), DATEADD(day, -2, GETDATE())),
(N'Ưng Hoàng Thông', 'thong.ung.music@artist.com', '0966002002', 'hashed_pw_customer017', NULL, 'Customer', 1, DATEADD(day, -15, GETDATE()), NULL), -- Never logged in
(N'Vạn Thị Uyên', 'uyen.van.beauty@style.com', '0966002003', 'hashed_pw_customer018', '033097000118', 'Customer', 1, DATEADD(day, -10, GETDATE()), DATEADD(day, -1, GETDATE())),
(N'Xa Văn Xuân', 'xuan.xa.travel@blog.com', '0966002004', 'hashed_pw_customer019', '033098000119', 'Customer', 1, DATEADD(day, -5, GETDATE()), NULL), -- Never logged in
(N'Yên Thị Yến', 'yen.yen.singer@stage.com', '0966002005', 'hashed_pw_customer020', '033099000120', 'Customer', 1, DATEADD(day, -2, GETDATE()), DATEADD(hour, -2, GETDATE()));

-- Batch 5: Some users for edge case testing (e.g. very long names, special chars in email if allowed by your validation)
INSERT INTO Users (FullName, Email, PhoneNumber, PasswordHash, IDCardNumber, Role, IsActive, CreatedAt, LastLogin) VALUES
(N'Alexandre Gustave Eiffel Tower Junior The Third', 'alex.eiffel.long.name.jr3@paris.fr', '0999888777', 'hashed_pw_longname', 'FR001234567', 'Customer', 1, DATEADD(day, -40, GETDATE()), DATEADD(day, -10, GETDATE())),
(N'김민준 (Kim Min-jun)', 'minjun.kim@seoul.kr', '0911999888', 'hashed_pw_korean', 'KR098765432', 'Customer', 1, DATEADD(day, -35, GETDATE()), DATEADD(day, -5, GETDATE())),
(N'Lý Tiểu Long "Bruce" Lee', 'bruce.lee.legend@kungfu.com', '0922777666', 'hashed_pw_bruce', NULL, 'Customer', 0, DATEADD(day, -1000, GETDATE()), DATEADD(day, -500, GETDATE())), -- Inactive legend
(N'User With-Hyphen@email-domain.com', 'user.with-hyphen@email-domain.com', '0933666555', 'hashed_pw_hyphen_email', 'IDH001122', 'Customer', 1, DATEADD(day, -25, GETDATE()), DATEADD(day, -3, GETDATE())),
(N'Another Staff Member', 'staff.generic01@vnrailway.com', '0906000006', 'hashed_pw_staff_generic01', 'S00000006', 'Staff', 1, DATEADD(month, -5, GETDATE()), DATEADD(day, -4, GETDATE()));
